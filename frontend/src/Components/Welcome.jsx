  ...
  return (
    <div className={`${styles.padding} w-full h-auto flex  items-center justify-between relative`}>
      ...
      <div className="w-full h-full flex flex-col sm:flex-row items-center justify-between relative">
        ...
        <p className="text-[20px] sm:text-[26px] font-medium text-[#6D603F] w-full sm:w-[60%] sm:tracking-wide  sm:h-[20%]">
            Welcome to Lamahi Chamber of Commerce
          </p>
          <p className="w-full sm:w-[70%] sm:text-start text-[14px] sm:text-[20px] h-[70%] font-medium mt-2 text-justify">
        ...
        <div className="w-full sm:w-[23%] mx-auto rounded-2xl h-[60%] flex flex-col justify-center z-2 items-center p-3 border-8 border-[#6D603F]">
          <div>
            <img src={about1} alt="mission-logo" />
          </div>
          <p className="text-[20px] sm:text-[22px] font-semibold w-full text-center text-[#6D603F]">
            Mission
          </p>
          <p className="text-[12px] sm:text-[14px] w-full p-3 opacity-[50%] font-semibold sm:tracking-widest sm:leading-loose">
        ...
        <div className="w-full sm:w-[23%] mx-auto rounded-2xl h-[60%] flex flex-col justify-center items-center mt-3 z-2 p-3 border-8 border-[#6D603F]">
          <div>
