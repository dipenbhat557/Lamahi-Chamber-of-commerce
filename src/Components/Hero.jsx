...
const Hero = () => {
  const clipPathStyle = {
    clipPath:
      "polygon(90% 0, 100% 55%, 84% 75%, 65% 81%, 33% 100%, 13% 69%, 21% 0)",
  };

  const clipPathStyle2 = {
    clipPath:
      "polygon(87% 1%, 81% 45%, 73% 69%, 65% 78%, 33% 100%, 9% 75%, 0 0)",
  };
  ...
  return (
    <>
      <div className="w-full h-[500px] sm:h-[880px] relative">
        {" "}
        {/* Adjusted class name */}
        <div className="w-full h-full -z-1 absolute inset-0">
          ...
          {heroElements.map((element, index) => (
            ...
            >
              <div
                className={`video-slide w-full h-full video-element z-[-1] ${
              ...
              >
                ...
                <button
                  className="border-2 border-red-200 py-1 sm:py-3 px-2 sm:px-5 text-white text-[16px] sm:text-[20px] rounded-3xl z-20"
