    ...
    <>
      ...
      <div className={`${styles.padding} w-full sm:flex gap-4`}>
        {[about1, about2, about3].map((image, index) => (
          <div
            key={index}
            className={`w-full sm:w-[20%] mx-auto rounded-2xl h-[60%] flex flex-col justify-center z-2 items-center p-3 border-8 border-[#6D603F] mt-2 sm:${index === 1 ? 'mt-4 sm:mt-0' : ''}`}
          >
            <div>
      ...
      <div className="w-full h-auto flex flex-col">
        <div className={`${styles.padding} flex h-[100px] sm:h-[150px] items-center gap-3`}>
